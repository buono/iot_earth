...
BlueJelly.prototype.connectGATT = function(uuid) {
  ...
  .then(service => {
    ...
    console.log(this.hashUUID[uuid]);
    console.log(this.hashUUID[uuid].characteristicUUID);
...
//Original service and characteristic for IOT Globe
Object.defineProperty(BlueJelly, 'IOT_GLOBE_SERVICE', {value: "a9101851-f33e-4855-a2ab-529d2b4f4a9b", writable: false});
Object.defineProperty(BlueJelly, 'IOT_GLOBE_CHARACTERISTIC', {value: "69f9db51-7482-48da-9663-ddda55daa3d2", writable: false});
